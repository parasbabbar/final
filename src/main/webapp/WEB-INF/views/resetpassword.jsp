...
<br>
 <div class="container">
You can reset password here ${tempemail}

<form action="${pageContext.request.contextPath}/performreset" method ="post">
<input type="password" name="passw" placeholeder="password">
<input type="submit">
</form>
