...
Your total order is$ ${totalcost}<br>
It will be delivered to ${sessionScope.address}<br>
Estimated time for delivery is 5 business days <br>
<a href="${pageContext.request.contextPath}/cont " method="GET">Continue Shopping</a>
