...
<title>About Us</title>
 <meta charset="utf-8">
  ...
  <link href="<c:url value="/resources/stuck.css"/>" rel="stylesheet" type="text/css">
   <link href="<c:url value="/resources/aboutus.css"/>" rel="stylesheet" type="text/css">
  
	<script src="<c:url value="/resources/aboutus.js"/>"></script>
...
$(document).ready(function(){
 ...
 $("#bf").mouseover(function(){
        ...
        $("#ig1").animate({height: "200px",width:"70%"});
...
<header >
We are Dressup.com!!<br><br>
</header>
<p>Before we talk about us, let us talk about you.</p>
<p>
You love fashion. That is right, we have got your number and we aim to provide you the latest fashion at your doorstep.  
</p><p>
